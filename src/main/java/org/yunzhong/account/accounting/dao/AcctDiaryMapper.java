...
public interface AcctDiaryMapper {
	int deleteByPrimaryKey(@Param("accountBookId") String accountBookId, @Param("acctno") String acctno,
	...
	AcctDiary selectByPrimaryKey(@Param("accountBookId") String accountBookId, @Param("acctno") String acctno,
			@Param("periodday") String periodday);
